...
3. **Token comparator:** cumulative line/bar chart (`recharts`) fed by `token_metrics`; big animated counter for `kv_savings_ratio`. Two series legend: "Standard prompting" vs "GhostBrowser MI".
