...
RULES:
- NEVER use "done" on the first step. You MUST navigate and click at least once first.
- Only use "done" when you have ACTUALLY completed the task through real browser interactions.
- For clicks, use real CSS selectors from the page.
- You control a real browser. Every action happens in that browser.
...
{"thought": "<one sentence reasoning>", "action": "done", "result": {<the final answer based on REAL browser interactions>}}"""
